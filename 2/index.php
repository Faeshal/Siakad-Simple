    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <h1><center><b>SISTEM IFORMASI AKADEMIK</b></center></h1>
          <center><img src="../aset/foto/ids.jpg" width="225" height="225" /></center>
          <center><h2><b>with stackoverflow power &copy;  <?php echo date ('Y') ?></b></h2></center>
          <center><h4><b>Made with <strong><i class="fa fa-code"></i></strong> and <i class="fa fa-heart"></i> by Faeshal</b></h4></center>
                </div><!-- /.box-header -->
                <div class="box-body">
