...
-- Dumping data for table siakad.dosen: ~4 rows (approximately)
/*!40000 ALTER TABLE `dosen` DISABLE KEYS */;
INSERT INTO `dosen` (`NIP`, `Nama_Dosen`, `Tanggal_Lahir`, `JK`, `No_Telp`, `Alamat`) VALUES
	('098980', 'Abdullah', '2017-03-15', 'L', '085693757554', 'Serang City '),
	('DS001', 'Ali', '2019-01-23', 'L', '084785696999', 'Kebun Jahe'),
	('DS003', 'Ibrahim', '2017-03-14', 'L', '087563251223', 'Green Bandung');
/*!40000 ALTER TABLE `dosen` ENABLE KEYS */;

-- Dumping structure for table siakad.jadwal
...
-- Dumping data for table siakad.jadwal: ~2 rows (approximately)
...
-- Dumping structure for table siakad.jenjang
...
-- Dumping data for table siakad.jenjang: ~5 rows (approximately)
...
-- Dumping structure for table siakad.jurusan
...
-- Dumping data for table siakad.jurusan: ~4 rows (approximately)
...
-- Dumping data for table siakad.mahasiswa: ~5 rows (approximately)
/*!40000 ALTER TABLE `mahasiswa` DISABLE KEYS */;
INSERT INTO `mahasiswa` (`NIM`, `Nama_Mahasiswa`, `Tanggal_Lahir`, `JK`, `No_Telp`, `Alamat`, `Kode_Jurusan_Mhs`) VALUES
	('D980082', 'Hasan', '2019-01-09', 'L', '085693654112', 'Warung Jaud', 'TIS1'),
	('D980083', 'Zaid', '1992-01-15', 'L', '085474747556', 'Serang Hijau', 'SID3'),
	('D980098', 'Faeshal', '2017-03-15', 'L', '085693757554', 'Kaligandu', 'TIS1'),
	('D980980', 'Umar', '2017-03-15', 'L', '085632145669', 'Cilegon', 'SID3'),
	('D980981', 'Ziyad', '1997-01-22', 'L', '087456925445', 'Pondok Indah', 'TIS1');
/*!40000 ALTER TABLE `mahasiswa` ENABLE KEYS */;

-- Dumping structure for table siakad.matakuliah
...
-- Dumping data for table siakad.matakuliah: ~8 rows (approximately)
/*!40000 ALTER TABLE `matakuliah` DISABLE KEYS */;
INSERT INTO `matakuliah` (`Kode_Matakuliah`, `Nama_Matakuliah`, `SKS`) VALUES
	('A01', 'Artificial Intellegence', 2),
	('A02', 'UI/UX', 2),
	('A03', 'Basis Data', 3),
	('A04', 'Logika Matematika', 2),
	('M01', 'Mobile Programming', 3),
	('MK01', 'Database', 2),
	('MK02', 'Manajemen Proyek Aplikasi', 3),
...
-- Dumping data for table siakad.nilai: ~3 rows (approximately)
...
-- Dumping structure for table siakad.ruangan
...
-- Dumping data for table siakad.ruangan: ~3 rows (approximately)
...
-- Dumping structure for table siakad.user
...
-- Dumping data for table siakad.user: ~3 rows (approximately)
...
INSERT INTO `user` (`Id_User`, `Id_Usergroup_User`, `Username`, `Password`, `Foto`) VALUES
	...
	(21, 2, 'DS003', '$2y$10$U3YX.fg.eebJkbjH2nMvKuW7/akLwBDQ0YBEUd4JelC0V8YEHYZuW', 'ids.jpg');
/*!40000 ALTER TABLE `user` ENABLE KEYS */;

-- Dumping structure for table siakad.usergroup
...
-- Dumping data for table siakad.usergroup: ~3 rows (approximately)
